...
export const DEFAULT_ERROR_MESSAGES: Record<ApiErrorCode, string> = {
	...
	[API_ERROR_CODES.AUTH_INVALID_CREDENTIALS]: "Invalid login credentials.",
	[API_ERROR_CODES.AUTH_ACCOUNT_NOT_VERIFIED]: "Your account is not verified yet.",
	[API_ERROR_CODES.AUTH_CODE_INVALID]: "The verification code is invalid.",
	[API_ERROR_CODES.AUTH_CODE_EXPIRED]: "The verification code has expired.",
	[API_ERROR_CODES.EMAIL_SERVICE_UNAVAILABLE]: "Email service is temporarily unavailable.",
	[API_ERROR_CODES.EMAIL_DELIVERY_FAILED]: "Email could not be delivered at this time.",
	...
	[API_ERROR_CODES.ROLE_NOT_FOUND]: "The requested role was not found.",
	[API_ERROR_CODES.PERMISSION_NOT_FOUND]: "The requested permission was not found.",
