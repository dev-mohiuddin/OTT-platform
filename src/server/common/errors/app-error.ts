...
const STATUS_BY_ERROR_CODE: Partial<Record<ApiErrorCode, HttpStatusCode>> = {
	...
	[API_ERROR_CODES.AUTH_INVALID_CREDENTIALS]: HTTP_STATUS.UNAUTHORIZED,
	[API_ERROR_CODES.AUTH_ACCOUNT_NOT_VERIFIED]: HTTP_STATUS.FORBIDDEN,
	[API_ERROR_CODES.AUTH_CODE_INVALID]: HTTP_STATUS.BAD_REQUEST,
	[API_ERROR_CODES.AUTH_CODE_EXPIRED]: HTTP_STATUS.BAD_REQUEST,
	[API_ERROR_CODES.EMAIL_SERVICE_UNAVAILABLE]: HTTP_STATUS.SERVICE_UNAVAILABLE,
	[API_ERROR_CODES.EMAIL_DELIVERY_FAILED]: HTTP_STATUS.SERVICE_UNAVAILABLE,
	[API_ERROR_CODES.NOT_FOUND]: HTTP_STATUS.NOT_FOUND,
	[API_ERROR_CODES.CONFLICT]: HTTP_STATUS.CONFLICT,
	[API_ERROR_CODES.ROLE_NOT_FOUND]: HTTP_STATUS.NOT_FOUND,
	[API_ERROR_CODES.PERMISSION_NOT_FOUND]: HTTP_STATUS.NOT_FOUND,
