...
import { getAdminSubscriptionsOverviewUseCase } from "@/server/modules/admin/use-cases/console.use-case";

export const GET = withApiHandler(async () => {
  await requirePermissionActor(ADMIN_PERMISSION.PANEL_ACCESS);

  const overview = await getAdminSubscriptionsOverviewUseCase();
